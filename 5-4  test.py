...
#    print(np.shape(tt))
    ...
    if pre == 1: img_id = 'dumianjin'
    # elif pre == 2: img_id = 'dumianjin'
    elif pre == 2: img_id = 'food'
    elif pre == 3: img_id = 'ganchao'
    elif pre == 4: img_id = 'gaoliyinyu'
    elif pre == 5: img_id = 'goubacai'
    elif pre == 6: img_id = 'goutaliji'
    elif pre == 7: img_id = 'jianhengdaxia'
    elif pre == 8: img_id = 'laobaosan'
    elif pre == 9: img_id = 'man'
    elif pre == 10: img_id = 'woman'
    else: img_id = 'None'
...
with tf.Session() as sess:  
    ...
    # 单张图片测试
    image_dir = './data/train/goubacai/058554.jpg'         #选取测试图片
    check_sex(image_dir,sess)
    # image_dir = test_dir + '\\dongporou' + '\\047316.jpg'  # 选取测试图片
    # check_sex(image_dir, sess)
    #
